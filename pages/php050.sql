...
INSERT INTO s2_articles_presse (titre, contenu, auteur, date_publication, match_id) VALUES
...
INSERT INTO s2_administrateurs (login, password_hash, droits) VALUES
('admin1', MD5('admin123'), 'admin'),
('editeur1', MD5('editeur123'), 'editeur'),
('lecteur1', MD5('lecteur123'), 'lecteur');


INSERT INTO s2_abonnes (nom, prenom, mail, age, genre, pays, date_abonnement, date_fin_abonnement) VALUES
